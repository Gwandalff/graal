...
public class WasmGE extends WasmNode {
	...
	public WasmGE(WasmModule wasmModule, WasmCodeEntry codeEntry, byte type, boolean signed) {
		super(wasmModule, codeEntry);
		this.type = type;
		this.signed = signed;
	}
	
	public WasmGE(WasmModule wasmModule, WasmCodeEntry codeEntry, byte type) {
		super(wasmModule, codeEntry);
		this.type = type;
		this.signed = true;
	}
