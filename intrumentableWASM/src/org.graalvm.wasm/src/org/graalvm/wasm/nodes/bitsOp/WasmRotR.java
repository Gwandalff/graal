...
public class WasmRotR extends WasmNode {

	@CompilationFinal private final byte type;

	public WasmRotR(WasmModule wasmModule, WasmCodeEntry codeEntry, int byteLength, byte type) {
	...
	public TargetOffset execute(WasmContext context, VirtualFrame frame) {
		...
		case ValueTypes.I64_TYPE: {
            ...
            context.stackpointer++;
            trace("push 0x%08X rotr 0x%08X = 0x%08X (%d) [i64]", y, x, result, result);
			break;
		}
		default:
			throw new WasmTrap(this, "RotR need the I** type.");
		}
		return null;
	}
