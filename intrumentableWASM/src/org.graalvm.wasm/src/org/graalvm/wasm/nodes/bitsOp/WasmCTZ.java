...
public class WasmCTZ extends WasmNode {

	@CompilationFinal private final byte type;

	public WasmCTZ(WasmModule wasmModule, WasmCodeEntry codeEntry, int byteLength, byte type) {
	...
	public TargetOffset execute(WasmContext context, VirtualFrame frame) {
		...
		case ValueTypes.I64_TYPE: {
            ...
            context.stackpointer++;
            trace("ctz(0x%016X) = 0x%08X (%d) [i64]", x, result, result);
			break;
		}
		default:
			throw new WasmTrap(this, "CTZ need the I** type.");
		}
		return null;
	}
