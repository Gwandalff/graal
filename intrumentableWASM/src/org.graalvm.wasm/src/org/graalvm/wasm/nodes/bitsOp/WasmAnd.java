...
public class WasmAnd extends WasmNode {
	
	@CompilationFinal private final byte type;

	public WasmAnd(WasmModule wasmModule, WasmCodeEntry codeEntry, int byteLength, byte type) {
	...
	public TargetOffset execute(WasmContext context, VirtualFrame frame) {
		...
		default:
			throw new WasmTrap(this, "And need the I** type.");
		}
		return null;
	}
